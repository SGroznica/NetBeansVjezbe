 ...
 */
package edunova.vjezba;

import edunova.model.vjezba.osnovno.Mobitel;
import edunova.model.vjezba.veze.Mjesto;
import edunova.model.vjezba.veze.Opcina;
...
public class Start {
    ...
    public Start() {
        this.session = HibernateUtil.geSession();
